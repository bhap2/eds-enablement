...
const parsers = { columns: columnsParser, "article-list": articleListParser };
...
const PAGE_TEMPLATE = {
  ...
  "blocks": [
    {
      "name": "columns",
      "instances": ["header.secondary-section .grid-layout", "#main-content > section.section:nth-of-type(1) .grid-layout"]
    },
    {
      "name": "article-list",
      "instances": ["#articles .grid-layout.desktop-4-column", "#articles .grid-layout"]
    }
  ]
};
